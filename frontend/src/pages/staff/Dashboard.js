...
import {
  ...
  Loader2, LayoutGrid, List, Settings, Zap, ArrowLeft, BookOpen, Megaphone, ShieldOff, FileText, Building2
} from 'lucide-react';
import {
      ...
      <header className="sticky top-0 z-40 bg-[var(--ink)]/96 backdrop-blur border-b border-white/8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/staff/content" className="text-white/58 hover:text-white p-1.5 rounded transition-colors duration-200" title="Content Manager">
              <FileText size={14} />
            </Link>
            <Link to="/staff/corporate" className="text-white/58 hover:text-white p-1.5 rounded transition-colors duration-200" title="Corporate Leads">
              <Building2 size={14} />
            </Link>
