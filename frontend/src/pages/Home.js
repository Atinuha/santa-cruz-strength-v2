  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--scs-bg)' }}>
      ...
      <main id="main">
        ...
        {/* ------------------------------------------------------------------
            COMMUNITY -- text only, no images added or reassigned.
            Reads home_who_headline, home_who_text, home_who_subtext from CMS.
            Renders only when those fields exist.
            ------------------------------------------------------------------ */}
        {c['home_who_headline'] && (
          <section className="py-16 sm:py-24" style={{ background: 'var(--scs-cream)' }} data-testid="home-community-section">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl mb-8 whitespace-pre-line" style={{ color: 'var(--scs-forest)', lineHeight: 0.96 }}>
                {c['home_who_headline']}
              </h2>
              {c['home_who_text'] && (
                <p className="text-base leading-relaxed max-w-[62ch] mb-4" style={{ color: 'var(--scs-text)' }}>
                  {c['home_who_text']}
                </p>
              )}
              {c['home_who_subtext'] && (
                <p className="text-base leading-relaxed max-w-[62ch]" style={{ color: 'var(--scs-text-muted)' }}>
                  {c['home_who_subtext']}
                </p>
              )}
            </div>
