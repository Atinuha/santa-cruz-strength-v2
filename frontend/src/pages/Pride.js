            ...
            <div className="animate-fade-in-up" data-testid="pride-form">
              ...
              <div className="mt-6 p-4 rounded-2xl bg-white border" style={{ borderColor: 'var(--clr-border)', boxShadow: 'var(--shadow-sm)' }}>
                <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <span className="text-sm font-bold ml-1" style={{ color: 'var(--clr-charcoal)' }}>4.9</span>
                </div>
                <p className="text-sm font-semibold mb-0.5" style={{ color: 'var(--clr-charcoal)' }}>Santa Cruz's #1 Strength Gym</p>
                <p className="text-xs text-[var(--clr-text-muted)] leading-relaxed">
                  "Best gym in town. Real equipment, real community, no ego."
                </p>
