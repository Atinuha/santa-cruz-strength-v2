...
//
// Each membership plan can carry its own GymMaster Online signup URL. When a
// plan's URL is set, its CTA opens GymMaster checkout directly. Plans without
// a URL route to the tour form at /contact#tour-request.
//
// GymMaster account #1193862 currently has zero membership types, no billing
// provider, and empty T&Cs/waiver records. All URLs below are empty until the
// business completes GymMaster setup.
//
// To add a plan's URL:
//   GymMaster -> Settings -> Membership Types -> [plan] -> Sell Membership
//   Online -> Enable Online Sign-Up -> Copy Buy Online Link -> paste below.
//
// ABC Fitness identifiers are retired. GymMaster is the sole checkout provider.
// ---------------------------------------------------------------------------

export const GYMMASTER_CHECKOUT_URLS = {
  'huscler-12':  '',   // 12-Month Membership $75/mo
  'annual':      '',   // Annual Paid in Full $825
  'flex':        '',   // Month-to-Month $120/mo
  'huscler-6':   '',   // 6-Month Membership $82/mo
  'couples-12':  '',   // 12-Month Couples $120/mo
  'couples-6':   '',   // 6-Month Couples $136/mo
  'weekend-12':  '',   // 12-Month Weekend $45/mo
  'weekend-6':   '',   // 6-Month Weekend $55/mo
};

export const MEMBERSHIP = {
  sellsOnline: false,
  tourUrl: '/contact#tour-request',
};

// Returns the checkout URL for a specific plan, or the tour fallback.
export const planCheckoutUrl = (planId) =>
  GYMMASTER_CHECKOUT_URLS[planId] || MEMBERSHIP.tourUrl;

// Generic join URL for emails/campaigns. Always the tour until GymMaster is ready.
export const joinUrl = () => MEMBERSHIP.tourUrl;
